...
tape( 'if provided a number outside `[0,1]` for `p` and a finite `mu` and `c`, the function returns `NaN`', opts, function test( t ) {
...
tape( 'if provided a negative `c`, the function returns `NaN`', opts, function test( t ) {
	var y;
